...
# Button for encoding
encode_btn = Button(window, text="Encode Image", height=2, width=15, bg="blue", fg="white", cursor="hand2", borderwidth=0,
                    command=open_encode_window)
encode_btn.config(font=("Open Sans", 15, "bold"))
encode_btn.pack(side=LEFT, padx=10)

# Button for decoding
decode_btn = Button(window, text="Decode Image", height=2, width=15, bg="red", fg="white", cursor="hand2", borderwidth=0,
...
# Footer label
footer_label = Label(window, text="Developed By Sonu Kushwaha")
